...
if (isset($_SESSION['username'])) {
    header("Location: ../PHP/Labour_login.php");
}
...
if (isset($_POST['submit'])) {
	...
	$sql = "SELECT * FROM cust_login WHERE email='$email' AND password='$password'";
	...
	if ($result->num_rows > 0) {
        ...
        session_start();
        session_destroy();
        header("Location: ../HTML/Cus_Home.html");
	} 
	else {
...
<body>
    <section class ="video-bg">
        <header>
            ...
            <h2 class="logo">Customers <b class="text-danger">Login</b></h2>
        </header>
                    ...
                    <div class="card bg-transparent">
                        <div class="container">
                            <form action="" method="POST" class="login-email">
                                ...
                                <div class="input-group has-validation">
                                    <input type="password" class="form-control" id="validationCustomUsername" name="password" placeholder="Password" value="<?php echo $_POST['password']; ?>"  required>
                                    <div class="invalid-feedback"> Please enter a Password.</div>
                                </div><br>
                                <div class="input-group">
                                    <button class="btn btn-primary" name="submit"type="submit" align="center">Login</button>
                                </div><br>
                                <p class="login-register-text">Don't have an account? <a href="Cust_SignUp.php">Register Here</a>.</p>
                            </form>
                        </div>
                    </div>
                </center>
