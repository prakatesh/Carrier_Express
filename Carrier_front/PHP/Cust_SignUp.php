...
if (isset($_POST['submit'])) {
	...
	if ($password == $cpassword) {
		...
		if (!$result->num_rows > 0) {
			$sql = "INSERT INTO cust_login (username, email, password)
...
<body>
    <section class ="video-bg">
        <header>
            ...
            <h2 class="logo">Customers <b class="text-danger">Sign Up</b></h2>
        </header>
                    ...
                    <div class="card bg-transparent">
                        <div class="container">
                            <form action="" method="POST"class="login-email needs-validation" novalidate>
                                ...
                                <div class="input-group has-validation">
                                    <input type="email" class="form-control" id="validationCustomUsername" placeholder="Enter Your Phone Number" value="<?php echo $email; ?>"  required>
                                ...
                                <p class="login-register-text">Have an account? <a href="Cust_login.php">Login Here</a>.</p>
                            </form>
                        </div>
                    </div>
                </center>    
